...
def main(args):
    # load input queries
    input_file = os.path.join(args.dir, "05_constrainted_question_format_number_filtered.json")
    output_file = os.path.join(args.dir, "06_answer_internal.json")

    constrainted_question = json.load(open(input_file, "r"))
    answer = {}

    # load prompt
    prompt = get_prompt("get answer internal")
